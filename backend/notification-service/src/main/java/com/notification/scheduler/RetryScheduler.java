...
public class RetryScheduler {
    ...
    @Transactional(rollbackFor = Exception.class)  // ← Plus explicite
public void processRetries() {
    ...
    for (Notification notification : notifications) {
        try {
            ...
            // ✅ Modifie l'objet en mémoire, ne sauvegarde PAS encore
    ...
    // ✅ UN SEUL saveAll() à la fin pour tout le batch
