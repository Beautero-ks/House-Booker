...
* The original package name 'com.intergiciel.notification-service' is invalid and this project uses 'com.intergiciel.notification_service' instead.
...
* [Spring for GraphQL](https://docs.spring.io/spring-boot/3.5.14/reference/web/spring-graphql.html)
