      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex flex-1 items-center justify-end gap-8">
            <Link to={ROUTES.HOME} className="text-gray-600 hover:text-primary font-medium">{t('nav_home')}</Link>
            <Link to={ROUTES.SEARCH} className="text-gray-600 hover:text-primary font-medium">{t('nav_listings')}</Link>
            <button
              type="button"
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-4">
                <Link to={ROUTES.DASHBOARD} className="text-gray-600 hover:text-primary font-medium">
                  {t('nav_dashboard')}
                </Link>
                ...
                <div className="relative" ref={profileMenuRef}>
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary"
                  >
              ...
              <div className="flex items-center gap-4">
                <Link to={ROUTES.LOGIN} className="text-gray-600 hover:text-primary font-medium">
                  {t('nav_login')}
                </Link>
